...
public class CP2_14 extends Fragment {
    ...
    Point p1 = new Point(139, 132);
    Point p2 = new Point(163, 51);
    Point p3 = new Point(198, 127);
    Point p4 = new Point(254, 77);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_14, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_014);
                mPlayer.start();
            }
        });
