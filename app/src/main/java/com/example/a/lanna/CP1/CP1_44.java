...
public class CP1_44 extends Fragment {
    ...
    Point p1 = new Point(164,152);
    Point p2 = new Point(104,298);
    Point p3 = new Point(274,147);
    Point p4 = new Point(279,305);
    Point p5 = new Point(306,234);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_44, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_044);
                mPlayer.start();
            }
        });
