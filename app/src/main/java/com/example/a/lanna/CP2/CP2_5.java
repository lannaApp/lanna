...
public class CP2_5 extends Fragment {
    ...
    Point p1 = new Point(62, 170);
    Point p2 = new Point(113, 217);
    Point p3 = new Point(39, 279);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_5, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_005);
                mPlayer.start();
            }
        });
