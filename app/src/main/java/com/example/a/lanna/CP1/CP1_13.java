...
public class CP1_13 extends Fragment {
    ...
    Point p1 = new Point(87,35);
    Point p2 = new Point(188,96);
    Point p3 = new Point(128,187);
    Point p4 = new Point(72,237);
    Point p5 = new Point(137,336);
    Point p6 = new Point(310,123);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_13, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_013);
                mPlayer.start();
            }
        });
