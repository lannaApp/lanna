...
public class CP4_12 extends Fragment {
    ...
    Point p1 = new Point(94, 304);
    Point p2 = new Point(229, 200);
    Point p3 = new Point(150, 196);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp4_12, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s4_002);
                mPlayer.start();
            }
        });
