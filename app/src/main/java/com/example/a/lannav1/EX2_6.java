...
public class EX2_6 extends Fragment {
     ...
     * @return A new instance of fragment EX2_6.
     */
    // TODO: Rename and change types and number of parameters
    public static EX2_6 newInstance(String param1, String param2) {
        EX2_6 fragment = new EX2_6();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ex2_6, container, false);
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MediaPlayer mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_021);
                mPlayer.start();
            }
        });
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EX2_true ext = EX2_true.newInstance("6",mParam2);
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EX2_false exf = EX2_false.newInstance("6",mParam2);
                FragmentManager manager = getActivity().getSupportFragmentManager();
                FragmentTransaction transaction = manager.beginTransaction();
