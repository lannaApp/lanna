...
public class CP1_33 extends Fragment {
    ...
    Point p1 = new Point(171,223);
    Point p2 = new Point(148,348);
    Point p3 = new Point(279,351);
    Point p4 = new Point(304,194);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_33, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_033);
                mPlayer.start();
            }
        });
