...
public class CP2_32 extends Fragment {
    ...
    Point p1 = new Point(73, 241);
    Point p2 = new Point(193, 41);
    Point p3 = new Point(165, 300);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_32, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_032);
                mPlayer.start();
            }
        });
