...
public class CP2_7 extends Fragment {
    ...
    Point p1 = new Point(134, 123);
    Point p2 = new Point(82, 233);
    Point p3 = new Point(195, 310);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_7, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_007);
                mPlayer.start();
            }
        });
