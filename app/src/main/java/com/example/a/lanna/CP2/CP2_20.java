...
public class CP2_20 extends Fragment {
    ...
    Point p1 = new Point(74, 154);
    Point p2 = new Point(56, 73);
    Point p3 = new Point(168, 155);
    Point p4 = new Point(149, 78);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_20, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_020);
                mPlayer.start();
            }
        });
