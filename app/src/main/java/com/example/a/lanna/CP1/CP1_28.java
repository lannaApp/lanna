...
public class CP1_28 extends Fragment {
    ...
    Point p1 = new Point(156,296);
    Point p2 = new Point(115,76);
    Point p3 = new Point(318,61);
    Point p4 = new Point(394,160);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_28, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_028);
                mPlayer.start();
            }
        });
