...
public class CP1_14 extends Fragment {
    ...
    Point p1 = new Point(178,112);
    Point p2 = new Point(82,242);
    Point p3 = new Point(216,228);
    Point p4 = new Point(358,186);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_14, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_014);
                mPlayer.start();
            }
        });
