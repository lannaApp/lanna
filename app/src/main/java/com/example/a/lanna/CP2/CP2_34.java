...
public class CP2_34 extends Fragment {
    ...
    Point p1 = new Point(179,252);
    Point p2 = new Point(230,107);
    Point p3 = new Point(162,28);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_34, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_034);
                mPlayer.start();
            }
        });
