...
public class CP1_12 extends Fragment {
    ...
    Point p1 = new Point(120,215);
    Point p2 = new Point(245,30);
    Point p3 = new Point(322,149);
    Point p4 = new Point(261,326);
    Point p5 = new Point(416,181);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_12, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_012);
                mPlayer.start();
            }
        });
