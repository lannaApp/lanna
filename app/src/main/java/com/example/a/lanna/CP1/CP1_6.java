...
public class CP1_6 extends Fragment {
    ...
    Point p1 = new Point(92,88);
    Point p2 = new Point(196,64);
    Point p3 = new Point(166,186);
    Point p4 = new Point(255,274);
    Point p5 = new Point(332,179);
    Point p6 = new Point(398,273);
    Point p7 = new Point(455,166);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_6, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_006);
                mPlayer.start();
            }
        });
