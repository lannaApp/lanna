...
public class CP1_45 extends Fragment {
    ...
    Point p1 = new Point(144,51);
    Point p2 = new Point(153,197);
    Point p3 = new Point(279,48);
    Point p4 = new Point(292,265);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_45, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_045);
                mPlayer.start();
            }
        });
