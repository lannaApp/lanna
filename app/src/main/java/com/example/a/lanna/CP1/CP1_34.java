...
public class CP1_34 extends Fragment {
    ...
    Point p1 = new Point(77,252);
    Point p2 = new Point(336,236);
    Point p3 = new Point(246,110);
    Point p4 = new Point(288,53);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_34, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_034);
                mPlayer.start();
            }
        });
