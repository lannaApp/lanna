...
public class CP1_9 extends Fragment {
    ...
    Point p1 = new Point(154,168);
    Point p2 = new Point(78,267);
    Point p3 = new Point(240,293);
    Point p4 = new Point(364,175);
    Point p5 = new Point(226,44);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_9, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_009);
                mPlayer.start();
            }
        });
