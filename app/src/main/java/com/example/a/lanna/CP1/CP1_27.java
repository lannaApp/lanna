...
public class CP1_27 extends Fragment {
    ...
    Point p1 = new Point(117,260);
    Point p2 = new Point(61,269);
    Point p3 = new Point(87,377);
    Point p4 = new Point(196,366);
    Point p5 = new Point(245,252);
    Point p6 = new Point(120,169);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_27, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_027);
                mPlayer.start();
            }
        });
