...
public class CP4_15 extends Fragment {
    ...
    Point p1 = new Point(208, 144);
    Point p2 = new Point(130, 212);
    Point p3 = new Point(170, 357);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp4_15, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s4_005);
                mPlayer.start();
            }
        });
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (count <= 1) {
                    //1
                    CPstar star1 = CPstar.newInstance("4", "1");
                    ;
                    FragmentManager manager = getActivity().getSupportFragmentManager();
                    FragmentTransaction transaction = manager.beginTransaction();
                    ...
                    CPstar2 star2 = CPstar2.newInstance("4", "1");
                    ;
                    FragmentManager manager = getActivity().getSupportFragmentManager();
                    FragmentTransaction transaction = manager.beginTransaction();
                    ...
                    CPstar3 star3 = CPstar3.newInstance("4", "1");
                    ;
                    FragmentManager manager = getActivity().getSupportFragmentManager();
                    FragmentTransaction transaction = manager.beginTransaction();
