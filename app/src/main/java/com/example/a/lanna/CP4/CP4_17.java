...
public class CP4_17 extends Fragment {
    ...
    Point p1 = new Point(122, 193);
    Point p2 = new Point(190, 295);
    Point p3 = new Point(167, 66);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp4_17, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s4_007);
                mPlayer.start();
            }
        });
