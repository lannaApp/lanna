...
public class CP1_16 extends Fragment {
    ...
    Point p1 = new Point(66,89);
    Point p2 = new Point(214,76);
    Point p3 = new Point(157,207);
    Point p4 = new Point(162,281);
    Point p5 = new Point(284,279);
    Point p6 = new Point(405,166);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_16, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_016);
                mPlayer.start();
            }
        });
