...
public class CP4_24 extends Fragment {
    ...
    Point p1 = new Point(74, 101);
    Point p2 = new Point(154, 69);
    Point p3 = new Point(74, 161);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp4_24, container, false);
