...
public class CP2_6 extends Fragment {
    ...
    Point p1 = new Point(106, 187);
    Point p2 = new Point(158, 236);
    Point p3 = new Point(77, 303);
    Point p4 = new Point(79, 107);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_6, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_006);
                mPlayer.start();
            }
        });
