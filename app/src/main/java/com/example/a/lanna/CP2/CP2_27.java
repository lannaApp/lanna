...
public class CP2_27 extends Fragment {
    ...
    Point p1 = new Point(123, 167);
    Point p2 = new Point(91, 80);
    Point p3 = new Point(261, 209);
    Point p4 = new Point(372, 171);
    Point p5 = new Point(419, 68);
    Point p6 = new Point(421, 136);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_27, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_027);
                mPlayer.start();
            }
        });
