...
public class CP1_42 extends Fragment {
    ...
    Point p1 = new Point(70,78);
    Point p2 = new Point(134,303);
    Point p3 = new Point(216,131);
    Point p4 = new Point(396,136);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_42, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_042);
                mPlayer.start();
            }
        });
