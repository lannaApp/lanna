...
public class CP1_2 extends Fragment {
    ...
    //x,y
    Point p1 = new Point(91,48);
    Point p2 = new Point(185,46);
    Point p3 = new Point(223,110);
    Point p4 = new Point(50,175);
    Point p5 = new Point(250,219);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_2, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_002);
                mPlayer.start();
            }
        });
