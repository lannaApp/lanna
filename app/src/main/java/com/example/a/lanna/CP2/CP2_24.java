...
public class CP2_24 extends Fragment {
    ...
    Point p1 = new Point(150,293);
    Point p2 = new Point(233,315);
    Point p3 = new Point(220,70);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_24, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_024);
                mPlayer.start();
            }
        });
