...
public class CP1_47 extends Fragment {
    ...
    Point p1 = new Point(219,109);
    Point p2 = new Point(95,111);
    Point p3 = new Point(210,183);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_47, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_047);
                mPlayer.start();
            }
        });
