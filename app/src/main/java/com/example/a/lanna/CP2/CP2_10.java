...
public class CP2_10 extends Fragment {
    ...
    Point p1 = new Point(232, 100);
    Point p2 = new Point(340, 92);
    Point p3 = new Point(292, 188);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_10, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_010);
                mPlayer.start();
            }
        });
