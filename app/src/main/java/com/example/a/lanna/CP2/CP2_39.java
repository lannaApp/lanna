...
public class CP2_39 extends Fragment {
    ...
    Point p1 = new Point(239, 136);
    Point p2 = new Point(350, 145);
    Point p3 = new Point(138, 48);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_39, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_039);
                mPlayer.start();
            }
        });
