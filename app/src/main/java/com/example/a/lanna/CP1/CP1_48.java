...
public class CP1_48 extends Fragment {
    ...
    Point p1 = new Point(66,222);
    Point p2 = new Point(79,82);
    Point p3 = new Point(220,233);
    Point p4 = new Point(235,76);
    Point p5 = new Point(379,233);
    Point p6 = new Point(411,68);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_48, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_048);
                mPlayer.start();
            }
        });
