...
public class CP1_46 extends Fragment {
    ...
    Point p1 = new Point(105,384);
    Point p2 = new Point(202,273);
    Point p3 = new Point(301,278);
    Point p4 = new Point(74,153);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_46, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_046);
                mPlayer.start();
            }
        });
