...
public class CP1_10 extends Fragment {
    ...
    Point p1 = new Point(167,228);
    Point p2 = new Point(112,127);
    Point p3 = new Point(228,53);
    Point p4 = new Point(303,183);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_10, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_010);
                mPlayer.start();
            }
        });
