...
public class CP1_22 extends Fragment {
    ...
    Point p1 = new Point(239,239);
    Point p2 = new Point(401,162);
    Point p3 = new Point(244,43);
    Point p4 = new Point(60,164);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_22, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_022);
                mPlayer.start();
            }
        });
