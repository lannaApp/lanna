...
public class CP1_35 extends Fragment {
    ...
    Point p1 = new Point(140,109);
    Point p2 = new Point(246,37);
    Point p3 = new Point(278,149);
    Point p4 = new Point(165,352);
    Point p5 = new Point(168,206);
    Point p6 = new Point(199,248);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_35, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_035);
                mPlayer.start();
            }
        });
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(count <= 2){
                    //1
                    CPstar star1 = CPstar.newInstance("1","2");;
                    FragmentManager manager = getActivity().getSupportFragmentManager();
                    FragmentTransaction transaction = manager.beginTransaction();
                    ...
                    CPstar2 star2 = CPstar2.newInstance("1","2");;
                    FragmentManager manager = getActivity().getSupportFragmentManager();
                    FragmentTransaction transaction = manager.beginTransaction();
                    ...
                    CPstar3 star3 = CPstar3.newInstance("1","2");;
                    FragmentManager manager = getActivity().getSupportFragmentManager();
                    FragmentTransaction transaction = manager.beginTransaction();
