...
public class CP3_8 extends Fragment {
    ...
    Point p1 = new Point(212, 129);
    Point p2 = new Point(156, 130);
    Point p3 = new Point(238, 77);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp3_8, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s3_008);
                mPlayer.start();
            }
        });
