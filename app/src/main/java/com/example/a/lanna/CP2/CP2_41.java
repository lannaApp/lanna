...
public class CP2_41 extends Fragment {
    ...
    Point p1 = new Point(231, 70);
    Point p2 = new Point(328, 144);
    Point p3 = new Point(127, 68);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_41, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_041);
                mPlayer.start();
            }
        });
