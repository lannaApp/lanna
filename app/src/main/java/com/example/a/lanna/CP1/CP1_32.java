...
public class CP1_32 extends Fragment {
    ...
    Point p1 = new Point(115,66);
    Point p2 = new Point(138,274);
    Point p3 = new Point(245,150);
    Point p4 = new Point(301,270);
    Point p5 = new Point(384,156);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_32, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_032);
                mPlayer.start();
            }
        });
