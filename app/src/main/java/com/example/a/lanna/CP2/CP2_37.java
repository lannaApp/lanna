...
public class CP2_37 extends Fragment {
    ...
    Point p1 = new Point(155, 122);
    Point p2 = new Point(155, 323);
    Point p3 = new Point(260, 257);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_37, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_037);
                mPlayer.start();
            }
        });
