...
public class CP4_28 extends Fragment {
    ...
    Point p1 = new Point(114, 126);
    Point p2 = new Point(216, 107);
    Point p3 = new Point(241, 307);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp4_28, container, false);
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(count <= 1){
                    //1
                    CPstar star1 = CPstar.newInstance("4","2");;
                    FragmentManager manager = getActivity().getSupportFragmentManager();
                    FragmentTransaction transaction = manager.beginTransaction();
                    ...
                    CPstar2 star2 = CPstar2.newInstance("4","2");;
                    FragmentManager manager = getActivity().getSupportFragmentManager();
                    FragmentTransaction transaction = manager.beginTransaction();
                    ...
                    CPstar3 star3 = CPstar3.newInstance("4","2");;
                    FragmentManager manager = getActivity().getSupportFragmentManager();
                    FragmentTransaction transaction = manager.beginTransaction();
