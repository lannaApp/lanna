...
public class CP2_33 extends Fragment {
    ...
    Point p1 = new Point(128, 301);
    Point p2 = new Point(190, 102);
    Point p3 = new Point(114, 44);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_33, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_033);
                mPlayer.start();
            }
        });
