...
public class CP4_22 extends Fragment {
    ...
    Point p1 = new Point(101, 77);
    Point p2 = new Point(145, 137);
    Point p3 = new Point(87, 206);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp4_22, container, false);
