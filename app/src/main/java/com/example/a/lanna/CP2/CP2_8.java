...
public class CP2_8 extends Fragment {
    ...
    Point p1 = new Point(104, 215);
    Point p2 = new Point(60, 147);
    Point p3 = new Point(311, 147);
    Point p4 = new Point(403, 144);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_8, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_008);
                mPlayer.start();
            }
        });
