...
public class CP1_19 extends Fragment {
    ...
    Point p1 = new Point(58,182);
    Point p2 = new Point(145,297);
    Point p3 = new Point(266,174);
    Point p4 = new Point(155,62);
    Point p5 = new Point(315,62);
    Point p6 = new Point(435,167);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_19, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_019);
                mPlayer.start();
            }
        });
