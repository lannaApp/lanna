...
public class CP2_26 extends Fragment {
    ...
    Point p1 = new Point(73, 285);
    Point p2 = new Point(176, 284);
    Point p3 = new Point(83, 30);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_26, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_026);
                mPlayer.start();
            }
        });
