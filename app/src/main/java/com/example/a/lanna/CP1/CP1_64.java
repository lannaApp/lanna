...
public class CP1_64 extends Fragment {
    ...
    Point p1 = new Point(197,311);
    Point p2 = new Point(212,253);
    Point p3 = new Point(366,212);
    Point p4 = new Point(301,282);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_64, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_064);
                mPlayer.start();
            }
        });

        FrameLayout layout = (FrameLayout) v.findViewById(R.id.fl_write);
        mView = new CP1_64.DrawingView(getActivity(),mPoints);
