...
public class CP1_43 extends Fragment {
    ...
    Point p1 = new Point(110,180);
    Point p2 = new Point(99,71);
    Point p3 = new Point(221,61);
    Point p4 = new Point(51,254);
    Point p5 = new Point(153,365);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_43, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_043);
                mPlayer.start();
            }
        });
