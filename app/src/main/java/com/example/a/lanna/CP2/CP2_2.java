...
public class CP2_2 extends Fragment {
    ...
    Point p1 = new Point(265, 142);
    Point p2 = new Point(364, 138);
    Point p3 = new Point(304, 227);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_2, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_002);
                mPlayer.start();
            }
        });
