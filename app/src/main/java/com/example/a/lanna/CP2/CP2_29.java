...
public class CP2_29 extends Fragment {
    ...
    Point p1 = new Point(90,149);
    Point p2 = new Point(202,40);
    Point p3 = new Point(196,226);
    Point p4 = new Point(321,128);
    Point p5 = new Point(401,141);
    Point p6 = new Point(432,112);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_29, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_029);
                mPlayer.start();
            }
        });
