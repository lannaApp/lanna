...
public class CP2_31 extends Fragment {
    ...
    Point p1 = new Point(115, 247);
    Point p2 = new Point(133, 155);
    Point p3 = new Point(229, 41);
    Point p4 = new Point(356, 146);
    Point p5 = new Point(357, 211);
    Point p6 = new Point(207, 297);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_31, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_031);
                mPlayer.start();
            }
        });
