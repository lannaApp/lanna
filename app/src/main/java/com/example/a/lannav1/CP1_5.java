...
public class CP1_5 extends Fragment {
    ...
    //x,y
    Point p1 = new Point(75,292);
    Point p2 = new Point(179,214);
    Point p3 = new Point(279,279);
    Point p4 = new Point(80,127);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_5, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_005);
                mPlayer.start();
            }
        });
