...
public class EX2_2 extends Fragment {
     ...
     * @return A new instance of fragment EX2_2.
     */
    // TODO: Rename and change types and number of parameters
    public static EX2_2 newInstance(String param1, String param2) {
        EX2_2 fragment = new EX2_2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ex2_2, container, false);
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MediaPlayer mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_008);
                mPlayer.start();
            }
        });
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EX2_true ext = EX2_true.newInstance("2",mParam2);
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EX2_false exf = EX2_false.newInstance("2",mParam2);
                FragmentManager manager = getActivity().getSupportFragmentManager();
                FragmentTransaction transaction = manager.beginTransaction();
