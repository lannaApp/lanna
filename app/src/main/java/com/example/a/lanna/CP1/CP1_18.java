...
public class CP1_18 extends Fragment {
    ...
    Point p1 = new Point(92,49);
    Point p2 = new Point(267,87);
    Point p3 = new Point(168,153);
    Point p4 = new Point(85,205);
    Point p5 = new Point(232,218);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_18, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_018);
                mPlayer.start();
            }
        });
