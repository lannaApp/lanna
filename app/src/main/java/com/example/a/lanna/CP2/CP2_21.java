...
public class CP2_21 extends Fragment {
    ...
    Point p1 = new Point(131, 286);
    Point p2 = new Point(92, 103);
    Point p3 = new Point(407, 156);
    Point p4 = new Point(408, 235);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_21, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_021);
                mPlayer.start();
            }
        });
