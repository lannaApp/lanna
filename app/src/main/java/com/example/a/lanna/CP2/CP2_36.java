...
public class CP2_36 extends Fragment {
    ...
    Point p1 = new Point(97, 154);
    Point p2 = new Point(72, 89);
    Point p3 = new Point(300, 80);
    Point p4 = new Point(359, 116);
    Point p5 = new Point(417, 119);
    Point p6 = new Point(464, 143);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_36, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_036);
                mPlayer.start();
            }
        });
