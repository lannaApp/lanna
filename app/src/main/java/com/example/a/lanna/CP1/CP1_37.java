...
public class CP1_37 extends Fragment {
    ...
    Point p1 = new Point(169,91);
    Point p2 = new Point(248,31);
    Point p3 = new Point(127,173);
    Point p4 = new Point(282,300);
    Point p5 = new Point(155,213);
    Point p6 = new Point(220,238);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_37, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_037);
                mPlayer.start();
            }
        });
