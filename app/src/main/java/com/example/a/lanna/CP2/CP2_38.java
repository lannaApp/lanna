...
public class CP2_38 extends Fragment {
    ...
    Point p1 = new Point(103, 293);
    Point p2 = new Point(239, 133);
    Point p3 = new Point(402, 210);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_38, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_038);
                mPlayer.start();
            }
        });
