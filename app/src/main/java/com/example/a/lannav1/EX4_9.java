...
public class EX4_9 extends Fragment {
     ...
     * @return A new instance of fragment EX4_9.
     */
    // TODO: Rename and change types and number of parameters
    public static EX4_9 newInstance(String param1, String param2) {
        EX4_9 fragment = new EX4_9();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ex4_9, container, false);
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EX4_true ext = EX4_true.newInstance("9", mParam2);
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EX4_false exf = EX4_false.newInstance("9",mParam2);
                FragmentManager manager = getActivity().getSupportFragmentManager();
                FragmentTransaction transaction = manager.beginTransaction();
