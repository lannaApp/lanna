...
public class CP1_38 extends Fragment {
    ...
    Point p1 = new Point(44,193);
    Point p2 = new Point(184,301);
    Point p3 = new Point(333,152);
    Point p4 = new Point(187,39);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_38, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_038);
                mPlayer.start();
            }
        });
