...
public class CP2_35 extends Fragment {
    ...
    Point p1 = new Point(182, 249);
    Point p2 = new Point(229, 105);
    Point p3 = new Point(154, 27);
    Point p4 = new Point(268, 280);
    Point p5 = new Point(337, 331);
    Point p6 = new Point(389, 200);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_35, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_035);
                mPlayer.start();
            }
        });
