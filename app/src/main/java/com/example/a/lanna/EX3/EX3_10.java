...
public class EX3_10 extends Fragment {
     ...
     * @return A new instance of fragment EX3_10.
     */
    // TODO: Rename and change types and number of parameters
    public static EX3_10 newInstance(String param1, String param2) {
        EX3_10 fragment = new EX3_10();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ex3_10, container, false);
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EX3_true ext = EX3_true.newInstance("10",mParam2+"0");
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EX3_false exf = EX3_false.newInstance("10",mParam2);
                FragmentManager manager = getActivity().getSupportFragmentManager();
                FragmentTransaction transaction = manager.beginTransaction();
