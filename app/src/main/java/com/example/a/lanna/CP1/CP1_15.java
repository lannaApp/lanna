...
public class CP1_15 extends Fragment {
    ...
    Point p1 = new Point(55,158);
    Point p2 = new Point(195,176);
    Point p3 = new Point(178,39);
    Point p4 = new Point(259,198);
    Point p5 = new Point(158,358);
    Point p6 = new Point(117,236);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_15, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_015);
                mPlayer.start();
            }
        });
