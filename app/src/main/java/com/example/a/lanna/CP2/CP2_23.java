...
public class CP2_23 extends Fragment {
    ...
    Point p1 = new Point(133,268);
    Point p2 = new Point(104,150);
    Point p3 = new Point(311,112);
    Point p4 = new Point(408,145);
    Point p5 = new Point(406,224);
    Point p6 = new Point(208,296);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_23, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_023);
                mPlayer.start();
            }
        });
