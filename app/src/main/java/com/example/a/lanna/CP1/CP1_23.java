...
public class CP1_23 extends Fragment {
    ...
    Point p1 = new Point(223,101);
    Point p2 = new Point(143,28);
    Point p3 = new Point(67,119);
    Point p4 = new Point(158,172);
    Point p5 = new Point(239,218);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_23, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_023);
                mPlayer.start();
            }
        });
