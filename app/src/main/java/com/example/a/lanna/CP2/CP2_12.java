...
public class CP2_12 extends Fragment {
    ...
    Point p1 = new Point(93, 90);
    Point p2 = new Point(100, 20);
    Point p3 = new Point(147, 70);
    Point p4 = new Point(171, 46);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_12, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_012);
                mPlayer.start();
            }
        });
