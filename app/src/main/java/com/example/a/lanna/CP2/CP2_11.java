...
public class CP2_11 extends Fragment {
    ...
    Point p1 = new Point(103, 100);
    Point p2 = new Point(110, 25);
    Point p3 = new Point(167, 83);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_11, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_011);
                mPlayer.start();
            }
        });
