...
public class CP1_21 extends Fragment {
    ...
    Point p1 = new Point(226,164);
    Point p2 = new Point(274,115);
    Point p3 = new Point(237,318);
    Point p4 = new Point(72,185);
    Point p5 = new Point(222,57);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_21, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_021);
                mPlayer.start();
            }
        });
