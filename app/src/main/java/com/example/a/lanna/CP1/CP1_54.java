...
public class CP1_54 extends Fragment {
    ...
    Point p1 = new Point(128,236);
    Point p2 = new Point(235,231);
    Point p3 = new Point(268,296);
    Point p4 = new Point(300,156);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_54, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_054);
                mPlayer.start();
            }
        });

        FrameLayout layout = (FrameLayout) v.findViewById(R.id.fl_write);
        mView = new CP1_54.DrawingView(getActivity(),mPoints);
