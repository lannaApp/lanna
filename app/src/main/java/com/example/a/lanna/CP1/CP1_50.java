...
public class CP1_50 extends Fragment {
    ...
    Point p1 = new Point(96,169);
    Point p2 = new Point(197,48);
    Point p3 = new Point(95,374);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_50, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_050);
                mPlayer.start();
            }
        });
