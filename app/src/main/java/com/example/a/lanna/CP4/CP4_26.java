...
public class CP4_26 extends Fragment {
    ...
    Point p1 = new Point(65, 108);
    Point p2 = new Point(177, 102);
    Point p3 = new Point(169, 275);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp4_26, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s4_006);
                mPlayer.start();
            }
        });
