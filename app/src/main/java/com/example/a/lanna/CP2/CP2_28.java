...
public class CP2_28 extends Fragment {
    ...
    Point p1 = new Point(85,168);
    Point p2 = new Point(58,79);
    Point p3 = new Point(227,212);
    Point p4 = new Point(336,156);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_28, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_028);
                mPlayer.start();
            }
        });
