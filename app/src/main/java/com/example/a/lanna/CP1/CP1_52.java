...
public class CP1_52 extends Fragment {
    ...
    Point p1 = new Point(135,197);
    Point p2 = new Point(217,192);
    Point p3 = new Point(140,250);
    Point p4 = new Point(282,148);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_52, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_052);
                mPlayer.start();
            }
        });

        FrameLayout layout = (FrameLayout) v.findViewById(R.id.fl_write);
        mView = new CP1_52.DrawingView(getActivity(),mPoints);
