...
public class CP1_29 extends Fragment {
    ...
    Point p1 = new Point(148,347);
    Point p2 = new Point(140,211);
    Point p3 = new Point(247,202);
    Point p4 = new Point(304,280);
    Point p5 = new Point(85,110);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_29, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_029);
                mPlayer.start();
            }
        });
