...
public class CP2_3 extends Fragment {
    ...
    Point p1 = new Point(98, 178);
    Point p2 = new Point(56, 91);
    Point p3 = new Point(221, 100);
    Point p4 = new Point(94, 273);
    Point p5 = new Point(183, 220);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_3, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_003);
                mPlayer.start();
            }
        });
