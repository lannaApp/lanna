...
public class CP1_49 extends Fragment {
    ...
    Point p1 = new Point(62,77);
    Point p2 = new Point(73,145);
    Point p3 = new Point(213,168);
    Point p4 = new Point(76,279);
    Point p5 = new Point(134,384);
    Point p6 = new Point(303,123);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_49, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_049);
                mPlayer.start();
            }
        });
