...
public class EX4_2 extends Fragment {
     ...
     * @return A new instance of fragment EX4_2.
     */
    // TODO: Rename and change types and number of parameters
    public static EX4_2 newInstance(String param1, String param2) {
        EX4_2 fragment = new EX4_2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ex4_2, container, false);
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EX4_true ext = EX4_true.newInstance("2", mParam2);
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EX4_false exf = EX4_false.newInstance("2",mParam2);
                FragmentManager manager = getActivity().getSupportFragmentManager();
                FragmentTransaction transaction = manager.beginTransaction();
