...
public class CP4_14 extends Fragment {
    ...
    Point p1 = new Point(82, 157);
    Point p2 = new Point(171, 284);
    Point p3 = new Point(159, 76);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp4_14, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s4_004);
                mPlayer.start();
            }
        });
