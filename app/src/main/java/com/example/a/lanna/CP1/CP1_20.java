...
public class CP1_20 extends Fragment {
    ...
    Point p1 = new Point(119,85);
    Point p2 = new Point(72,276);
    Point p3 = new Point(320,296);
    Point p4 = new Point(335,169);
    Point p5 = new Point(225,41);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_20, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_020);
                mPlayer.start();
            }
        });
