...
public class CP1_26 extends Fragment {
    ...
    Point p1 = new Point(159,123);
    Point p2 = new Point(84,277);
    Point p3 = new Point(290,298);
    Point p4 = new Point(379,174);
    Point p5 = new Point(291,85);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_26, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_026);
                mPlayer.start();
            }
        });
