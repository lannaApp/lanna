...
public class EX2_4 extends Fragment {
     ...
     * @return A new instance of fragment EX2_4.
     */
    // TODO: Rename and change types and number of parameters
    public static EX2_4 newInstance(String param1, String param2) {
        EX2_4 fragment = new EX2_4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EX2_true ext = EX2_true.newInstance("4",mParam2);
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EX2_false exf = EX2_false.newInstance("4",mParam2);
                FragmentManager manager = getActivity().getSupportFragmentManager();
                FragmentTransaction transaction = manager.beginTransaction();
