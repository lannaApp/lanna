...
public class CP1_11 extends Fragment {
    ...
    Point p1 = new Point(126,272);
    Point p2 = new Point(73,226);
    Point p3 = new Point(155,154);
    Point p4 = new Point(212,225);
    Point p5 = new Point(81,92);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_011);
                mPlayer.start();
            }
        });
