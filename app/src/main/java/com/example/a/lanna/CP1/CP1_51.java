...
public class CP1_51 extends Fragment {
    ...
    Point p1 = new Point(85,204);
    Point p2 = new Point(145,213);
    Point p3 = new Point(161,260);
    Point p4 = new Point(239,245);
    Point p5 = new Point(258,98);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_51, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_051);
                mPlayer.start();
            }
        });

        FrameLayout layout = (FrameLayout) v.findViewById(R.id.fl_write);
        mView = new CP1_51.DrawingView(getActivity(),mPoints);
