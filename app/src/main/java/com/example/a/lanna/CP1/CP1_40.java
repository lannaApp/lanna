...
public class CP1_40 extends Fragment {
    ...
    Point p1 = new Point(73,284);
    Point p2 = new Point(141,112);
    Point p3 = new Point(289,310);
    Point p4 = new Point(300,114);
    Point p5 = new Point(336,240);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_40, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_040);
                mPlayer.start();
            }
        });
