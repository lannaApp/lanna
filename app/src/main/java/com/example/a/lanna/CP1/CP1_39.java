...
public class CP1_39 extends Fragment {
    ...
    Point p1 = new Point(162,329);
    Point p2 = new Point(213,104);
    Point p3 = new Point(365,207);
    Point p4 = new Point(277,189);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_39, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_039);
                mPlayer.start();
            }
        });
