...
public class CP2_17 extends Fragment {
    ...
    Point p1 = new Point(106, 175);
    Point p2 = new Point(76, 85);
    Point p3 = new Point(361, 65);
    Point p4 = new Point(358, 135);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_17, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_017);
                mPlayer.start();
            }
        });
