...
public class CP2_19 extends Fragment {
    ...
    Point p1 = new Point(97, 151);
    Point p2 = new Point(68, 80);
    Point p3 = new Point(195, 151);
    Point p4 = new Point(169, 77);
    Point p5 = new Point(387, 59);
    Point p6 = new Point(391, 119);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_19, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_019);
                mPlayer.start();
            }
        });
