...
public class CP2_4 extends Fragment {
    ...
    Point p1 = new Point(111, 176);
    Point p2 = new Point(86, 76);
    Point p3 = new Point(233, 100);
    Point p4 = new Point(106, 276);
    Point p5 = new Point(209, 231);
    Point p6 = new Point(292, 212);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_4, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_004);
                mPlayer.start();
            }
        });
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (count <= 2) {
                    //1
                    CPstar star1 = CPstar.newInstance("2", "1");
                    ;
                    FragmentManager manager = getActivity().getSupportFragmentManager();
                    FragmentTransaction transaction = manager.beginTransaction();
                    ...
                    CPstar2 star2 = CPstar2.newInstance("2", "1");
                    ;
                    FragmentManager manager = getActivity().getSupportFragmentManager();
                    FragmentTransaction transaction = manager.beginTransaction();
                    ...
                    CPstar3 star3 = CPstar3.newInstance("2", "1");
                    ;
                    FragmentManager manager = getActivity().getSupportFragmentManager();
                    FragmentTransaction transaction = manager.beginTransaction();
