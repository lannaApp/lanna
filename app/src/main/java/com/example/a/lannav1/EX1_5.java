...
public class EX1_5 extends Fragment {
     ...
     * @return A new instance of fragment EX1_5.
     */
    // TODO: Rename and change types and number of parameters
    public static EX1_5 newInstance(String param1, String param2) {
        EX1_5 fragment = new EX1_5();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ex1_5, container, false);
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EX1_true ext = EX1_true.newInstance("5",mParam2);
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EX1_false exf = EX1_false.newInstance("5",mParam2);
                FragmentManager manager = getActivity().getSupportFragmentManager();
                FragmentTransaction transaction = manager.beginTransaction();
