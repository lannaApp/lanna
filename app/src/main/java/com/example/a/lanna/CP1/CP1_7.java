...
public class CP1_7 extends Fragment {
    ...
    Point p1 = new Point(190,231);
    Point p2 = new Point(64,222);
    Point p3 = new Point(154,84);
    Point p4 = new Point(280,56);
    Point p5 = new Point(384,155);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_7, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_007);
                mPlayer.start();
            }
        });
