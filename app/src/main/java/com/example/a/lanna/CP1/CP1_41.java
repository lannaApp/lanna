...
public class CP1_41 extends Fragment {
    ...
    Point p1 = new Point(65,193);
    Point p2 = new Point(120,75);
    Point p3 = new Point(294,267);
    Point p4 = new Point(297,66);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_41, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_041);
                mPlayer.start();
            }
        });
