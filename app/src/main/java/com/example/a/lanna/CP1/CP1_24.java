...
public class CP1_24 extends Fragment {
    ...
    Point p1 = new Point(113,52);
    Point p2 = new Point(62,220);
    Point p3 = new Point(206,315);
    Point p4 = new Point(357,196);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_24, container, false);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_024);
                mPlayer.start();
            }
        });
