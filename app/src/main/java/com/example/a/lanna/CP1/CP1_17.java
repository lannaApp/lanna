...
public class CP1_17 extends Fragment {
    ...
    Point p1 = new Point(53,146);
    Point p2 = new Point(139,37);
    Point p3 = new Point(199,169);
    Point p4 = new Point(297,183);
    Point p5 = new Point(333,34);
    Point p6 = new Point(418,130);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_17, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_017);
                mPlayer.start();
            }
        });
