...
public class CP1_59 extends Fragment {
    ...
    Point p1 = new Point(307,243);
    Point p2 = new Point(223,371);
    Point p3 = new Point(165,282);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_59, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_059);
                mPlayer.start();
            }
        });

        FrameLayout layout = (FrameLayout) v.findViewById(R.id.fl_write);
        mView = new CP1_59.DrawingView(getActivity(),mPoints);
