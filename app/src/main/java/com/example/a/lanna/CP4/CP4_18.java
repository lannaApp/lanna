...
public class CP4_18 extends Fragment {
    ...
    Point p1 = new Point(179, 145);
    Point p2 = new Point(215, 242);
    Point p3 = new Point(375, 153);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp4_18, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s4_008);
                mPlayer.start();
            }
        });
