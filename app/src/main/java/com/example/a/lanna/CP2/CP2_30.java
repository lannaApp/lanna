...
public class CP2_30 extends Fragment {
    ...
    Point p1 = new Point(83, 221);
    Point p2 = new Point(168, 111);
    Point p3 = new Point(153, 265);
    Point p4 = new Point(286, 167);
    Point p5 = new Point(349, 157);
    Point p6 = new Point(333, 223);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_30, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_030);
                mPlayer.start();
            }
        });
