...
public class CP1_31 extends Fragment {
    ...
    Point p1 = new Point(71,72);
    Point p2 = new Point(47,221);
    Point p3 = new Point(188,317);
    Point p4 = new Point(342,179);
    Point p5 = new Point(258,227);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp1_31, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s1_031);
                mPlayer.start();
            }
        });
