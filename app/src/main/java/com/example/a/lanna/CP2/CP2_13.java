...
public class CP2_13 extends Fragment {
    ...
    Point p1 = new Point(81, 119);
    Point p2 = new Point(110, 38);
    Point p3 = new Point(153, 118);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_13, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_013);
                mPlayer.start();
            }
        });
