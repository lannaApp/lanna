...
public class EX1_3 extends Fragment {
     ...
     * @return A new instance of fragment EX1_3.
     */
    // TODO: Rename and change types and number of parameters
    public static EX1_3 newInstance(String param1, String param2) {
        EX1_3 fragment = new EX1_3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ex1_3, container, false);
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EX1_true ext = EX1_true.newInstance("3", mParam2);
        ...
        newImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EX1_false exf = EX1_false.newInstance("3",mParam2);
                FragmentManager manager = getActivity().getSupportFragmentManager();
                FragmentTransaction transaction = manager.beginTransaction();
