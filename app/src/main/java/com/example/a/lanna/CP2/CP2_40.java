...
public class CP2_40 extends Fragment {
    ...
    Point p1 = new Point(229, 71);
    Point p2 = new Point(323, 146);
    Point p3 = new Point(298, 245);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cp2_40, container, false);
        ...
        bt_sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayer = MediaPlayer.create(getActivity(), R.raw.s2_040);
                mPlayer.start();
            }
        });
